...
function ProfilePage() {
  ...
  const calculateBMI = () => {
    if (profile?.height && profile?.current_weight) {
      const heightInMeters = profile.height / 100;
      const bmi = profile.current_weight / (heightInMeters * heightInMeters);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              {calculateBMI() && (
                <div className="p-4 bg-white border-2 border-teal-100 rounded-xl shadow-inner mt-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-[10px] font-black text-teal-500 uppercase tracking-widest">Calculated BMI</p>
                      <p className="text-3xl font-black text-teal-900">{calculateBMI()}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[10px] font-black text-teal-500 uppercase tracking-widest">Category</p>
                      <p className={`text-sm font-black uppercase ${getBMICategory(parseFloat(calculateBMI()!)).color}`}>
