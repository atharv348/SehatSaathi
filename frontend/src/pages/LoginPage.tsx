      ...
      <div className="w-full max-w-md">
          <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-blue-200">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-bold text-blue-900">SehatSaathi</h1>
        ...
        {/* Footer Note */}
        <div className="text-center text-green-600 text-xs mt-6 font-medium flex items-center justify-center gap-2">
